...
export default () => {
    return (
        <>
            <div css={tw`md:w-1/2 h-full bg-white dark:bg-neutral-700`}>
                <div css={tw`flex flex-col`}>
                    <h2 css={tw`py-4 px-6 font-bold`}>Examples</h2>
                    <div css={tw`flex py-4 px-6 bg-neutral-100 dark:bg-neutral-600`}>
            ...
            <div css={tw`md:w-1/2 h-full bg-white dark:bg-neutral-700`}>
                ...
                <div css={tw`flex flex-col`}>
                    <div css={tw`flex py-4 px-6 bg-neutral-100 dark:bg-neutral-500`}>
