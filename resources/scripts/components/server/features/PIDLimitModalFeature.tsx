        ...
        >
            ...
            {isAdmin ? (
                <>
                    ...
                    <p css={tw`mt-4`}>
                        Increasing{' '}
                        <code css={tw`font-mono bg-neutral-100 dark:bg-neutral-900`}>container_pid_limit</code> in the
                        wings configuration,{' '}
                        <code css={tw`font-mono bg-neutral-100 dark:bg-neutral-900`}>config.yml</code>, might help
                        resolve this issue.
                    </p>
                    <p css={tw`mt-4`}>
                ...
                <>
                    ...
                    <p css={tw`mt-4`}>
                        <code css={tw`font-mono bg-neutral-100 dark:bg-neutral-900`}>
