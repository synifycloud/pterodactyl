    ...
    return (
        <div className={classNames('my-2 flex items-center justify-between', className)}>
            <p className={'text-sm text-neutral-600 dark:text-neutral-500'}>
                ...
                &nbsp;to&nbsp;
                <span className={'font-semibold text-neutral-700 dark:text-neutral-400'}>{end}</span> of&nbsp;
                <span className={'font-semibold text-neutral-700 dark:text-neutral-400'}>{pagination.total}</span>{' '}
                results.
            </p>
