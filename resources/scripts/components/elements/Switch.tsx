...
const ToggleContainer = styled.div`
    ...
    & > input[type='checkbox'] {
        ...
        &:checked + label {
            ${tw`bg-indigo-500 border-indigo-700 shadow-none`};
        }
    ...
    & > label {
        ${tw`mb-0 block overflow-hidden cursor-pointer bg-neutral-400 border border-neutral-400 dark:border-neutral-700 rounded-full h-6 shadow-inner`};
