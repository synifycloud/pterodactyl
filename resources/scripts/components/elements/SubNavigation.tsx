...
const Navigation = styled.div`
    ...
    & > div {
        ${tw`flex flex-col items-center text-sm mx-auto xl:px-2`};

        & > a,
        & > div {
            ${tw`inline-block relative w-full flex items-center justify-center xl:justify-start py-3 px-4 text-neutral-400 no-underline whitespace-nowrap gap-2 transition-all duration-150`};
        ...
        <Navigation>
            <Link to='/'>
                <svg
                    ...
                    className='mx-auto mt-4 w-4/6 fill-indigo-600'
                >
