                        ...
                        keys.map((key, index) => (
                            <GreyRowBox key={key.identifier} css={[tw`flex items-center`, index > 0 && tw`mt-2`]}>
                                ...
                                <p css={tw`text-sm ml-4 hidden md:block`}>
                                    <code css={tw`font-mono py-1 px-2 bg-neutral-100 dark:bg-neutral-900 rounded`}>
                                        {key.identifier}
                                    </code>
                                </p>
                                <button
                                    css={tw`ml-4 p-2 text-sm text-neutral-700 dark:text-neutral-400 hover:text-red-400 transition-colors duration-150`}
